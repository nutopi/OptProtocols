...
def volume_test(disp_vol, times, tube_on_weight):
    ...
    if not (labware_list.__contains__(tube_on_weight)):
    ...
    weight_2ml = labware.load('tube_2ml_weight', slot='5')
    ...
    for i in range(times):
        ...
        robot.pause()
        single.dispense(disp_vol, weight_2ml(0))
        robot.pause()
...
disp_vol1 = 10
times1 = 10
volume_test(disp_vol1, times1, 'tube_2ml_weight')
