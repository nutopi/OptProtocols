...
def serial_dil(begin_vol, final_vol, tube_amount):
    ...
    tubes1 = labware.load('tube_rack_35', slot='1')
    tubes2 = labware.load('tube_rack_35', slot='2')
    tubes3 = labware.load('tube_rack_35', slot='3')
    tubes4 = labware.load('tube_rack_35', slot='4')
    tip_rack_small = labware.load('opentrons-tiprack-300ul', slot='6')
    tip_rack_big = labware.load('tiprack-1000ul', slot='9')
    plasma_falcon = labware.load('big_falcons_rack', slot='5')
