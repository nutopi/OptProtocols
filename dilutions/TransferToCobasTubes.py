...
cobas_tube_rack_35 = "cobas_tubes_rack_35"
if tube_rack_35 not in labware.list():
    cobas_tube_rack_35 = labware.create("cobas_tubes_rack_35",
                                  grid=(7, 5),
                                  spacing=(16.25, 14.56),
                                  diameter=9,
                                  depth=35)

dest_tube_rack_A = labware.load('cobas_tubes_rack_35', slot='4')
dest_tube_rack_B = labware.load('cobas_tubes_rack_35', slot='5')
dest_tube_rack_C = labware.load('cobas_tubes_rack_35', slot='6')
dest_tube_rack_D = labware.load('cobas_tubes_rack_35', slot='1')
dest_tube_rack_E = labware.load('cobas_tubes_rack_35', slot='2')
dest_tube_rack_F = labware.load('cobas_tubes_rack_35', slot='3')
...
=======
        used_pipette.dispense(used_pipette.current_volume, destination.bottom(5))
>>>>>>> 4f2583be489331912b28db19731b903fd894c39a
